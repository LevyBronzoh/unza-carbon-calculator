...
<div class="dashboard-container">
    ...
    <div class="container">
        @if($hasData || (isset($baselineData) && $baselineData) || (isset($projectData) && $projectData))
            <div class="row mb-4">
                <div class="col-12">
                    <h2 class="fw-bold">@auth My @endauth Carbon Dashboard</h2>
                </div>
            </div>
                            ...
                            @if(($baselineData ?? $baseline))
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="fw-bold">{{ ($baselineData->stove_type ?? $baseline->stove_type) ?? 'Not specified' }}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>Fuel Type:</span>
                                        <span class="fw-bold">{{ ($baselineData->fuel_type ?? $baseline->fuel_type) ?? 'Not specified' }}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>Daily Cooking Time:</span>
                                        <span class="fw-bold">{{ ($baselineData->daily_hours ?? $baseline->daily_hours) ?? 0 }} hours</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>Daily Fuel Use:</span>
                                        <span class="fw-bold">{{ ($baselineData->daily_fuel_use ?? $baseline->daily_fuel_use) ?? 0 }} kg/liters</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>Estimated Monthly Emissions:</span>
                                        <span class="fw-bold text-danger">
                                            {{ number_format(($baselineData->emission_total ?? ($emissionsData['baseline_emissions'] ?? 0)), 3) }} tCO₂e
                                        </span>
                                    </li>
                                </ul>
                                <div class="mt-3">
                                    <a href="{{ route('baseline.edit', $baselineData->id ?? $baseline->id) }}" class="btn btn-outline-primary">
                            ...
                            @if(($projectData ?? $project))
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="fw-bold">{{ ($projectData->new_stove_type ?? $project->new_stove_type) ?? 'Not specified' }}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>New Fuel Type:</span>
                                        <span class="fw-bold">{{ ($projectData->new_fuel_type ?? $project->new_fuel_type) ?? 'Not specified' }}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>Estimated Monthly Emissions:</span>
                                        <span class="fw-bold text-danger">
                                            {{ number_format(($projectData->emissions_after ?? ($emissionsData['project_emissions'] ?? 0)), 3) }} tCO₂e
                                        </span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>Monthly Emission Reduction:</span>
                                        <span class="fw-bold text-success">
                                            {{ number_format(($projectData->credits_earned ?? ($emissionsData['reduction'] ?? 0)), 3) }} tCO₂e
                                        </span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>Since:</span>
                                        <span class="fw-bold">{{ optional($projectData->start_date ?? $project->start_date)->format('M d, Y') ?? 'Not specified' }}</span>
                                    </li>
                                </ul>
                                <div class="mt-3">
                                    <a href="{{ route('project.edit', $projectData->id ?? $project->id) }}" class="btn btn-outline-success">
            ...
            @if($emissionsData || $dashboardMetrics)
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body text-center">
                                            ...
                                            <h3 class="text-success">
                                                {{ number_format(($dashboardMetrics['monthly_credits_earned'] ?? $emissionsData['reduction'] ?? 0), 3) }} tCO₂e
                                            </h3>
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body text-center">
                                            ...
                                            <h3 class="text-primary">
                                                {{ number_format(($dashboardMetrics['cumulative_credits'] ?? $emissionsData['cumulative_reduction'] ?? 0), 3) }} tCO₂e
                                            </h3>
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body text-center">
                                            ...
                                            <h3 class="text-warning">
                                                {{ $dashboardMetrics['percentage_reduction'] ?? $emissionsData['reduction_percentage'] ?? 0 }}%
                                            </h3>
        ...
        @else
            ...
            <div class="alert alert-info">
                <h4>Welcome to UNZA Carbon Calculator!</h4>
                <p>Get started by entering your baseline cooking data.</p>
                <a href="{{ route('baseline.create') }}" class="btn btn-primary">
                    <i class="fas fa-plus-circle me-1"></i> Add Baseline Data
                </a>
            </div>
